...
export const CATEGORIES: CategoryItem[] = [
  ...
  },
  {
    ...
    icon: 'Sparkles',
    description: '18K gold-plated chains, crystal rings, huggie earrings, luxury watches & bags',
    image: '/gifts/Jewellery/Chains/IMG_3990.JPG',
    itemCount: '67 Pieces',
    tag: 'Precious & Fine',
  },
  {
    id: 'traveling-items',
    name: 'Travel Accessories & Organizers',
    icon: 'Package',
    description: 'Leather passport wallets, cosmetic vanity cases, duffel bags & packing cubes',
    image: '/gifts/Traveling item/4c0e81a58e8b4668a6a21fd2d74ee247.jpg',
    itemCount: '7 Essentials',
    tag: 'Wanderlust',
  },
  {
    id: 'background-decoration-kits',
    name: 'Background Decoration Kits',
    icon: 'Sparkles',
    description: 'Celebration balloon arches, fairy light backdrop suites & party foil curtains',
    image: '/gifts/Background decoration kit/229498704778b851a2ae6a867bcb002d.jpg',
    itemCount: '11 Party Kits',
    tag: 'Party & Glow',
  },
];
