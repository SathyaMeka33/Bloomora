...
CATEGORIES = [
    ...
    {"name": "Chocolate Bouquets", "slug": "chocolate-bouquets", "icon": "Gift", "description": "Artisanal truffles wrapped in velvet", "sort_order": 2},
    {"name": "Curated Hampers", "slug": "gift-hampers", "icon": "ShoppingBag", "description": "Multi-item emotional experiences", "sort_order": 3},
    {"name": "Keepsake Boxes", "slug": "luxury-boxes", "icon": "Box", "description": "Rigid magnetic memory chests", "sort_order": 4},
    {"name": "Personalized Keepsakes", "slug": "personalized", "icon": "Heart", "description": "Illuminated photo memories", "sort_order": 5},
    {"name": "Pocket Surprises", "slug": "mini-gifts", "icon": "Sparkles", "description": "Charming gestures under Rs.299", "sort_order": 6},
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("🌸 Seeding Bloomora database..."))
